...
export const VLOGGING_PRODUCTS = [
  // --- INDIAN MARKET FAVORITES & BUDGET HEROES ---
  {
    ...
    mrpINR: 7995,
    priceUSD: 42.00,
    image: "/images/products/digitek-dwm-101.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 1999,
    priceUSD: 8.50,
    image: "/images/products/boya-by-m1.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 9999,
    priceUSD: 60.00,
    image: "/images/products/dji-mic-2.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 4995,
    priceUSD: 30.00,
    image: "/images/products/digitek-dptr-890vd.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 999,
    priceUSD: 4.20,
    image: "/images/products/tygot-gorilla-tripod.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 5995,
    priceUSD: 33.50,
    image: "/images/products/digitek-drl-18h.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 2999,
    priceUSD: 14.50,
    image: "/images/products/osaka-pocket-led.jpg",
    inStock: true,
    deliverySpeed: "Next-Day Delivery",
    specs: {
  ...
  // --- GLOBAL FLAGSHIP CREATOR PRODUCTS WITH INDIAN PRICING ---
  {
    ...
    mrpINR: 89990,
    priceUSD: 998.00,
    image: "/images/products/sony-zv-e10-ii.jpg",
    inStock: true,
  ...
  },
  {
    ...
    mrpINR: 7490,
    priceUSD: 69.90,
    image: "/images/products/smallrig-universal-phone-cage.jpg",
    inStock: true,
    deliverySpeed: "Standard 2-Day Delivery",
    specs: {
  ...
  },
  {
    ...
    mrpINR: 15990,
    priceUSD: 139.00,
    image: "/images/products/dji-osmo-mobile-6.jpg",
    inStock: true,
    deliverySpeed: "Next-Day Delivery",
    specs: {
      stabilization: "3-Axis Motorized Gimbal",
  ...
  },
  {
    ...
    mrpINR: 3499,
    priceUSD: 22.95,
    image: "/images/products/ulanzi-vl49-rgb.jpg",
    inStock: true,
    deliverySpeed: "Next-Day Delivery",
    specs: {
  ...
  },
  {
    ...
    mrpINR: 4850,
    priceUSD: 34.99,
    image: "/images/products/sandisk-extreme-pro-256gb.jpg",
    inStock: true,
    deliverySpeed: "Prime Next-Day Delivery",
    specs: {
...
// --- HISTORICAL & LINEAGE PRODUCTS (Start to Live Current in Market) ---
export const LINEAGE_PRODUCTS = [
  // 1. DJI Osmo Pocket Series Lineage
  {
    id: "dji-osmo-pocket-1",
    market: "global",
    title: "DJI Osmo Pocket 1 Handheld 3-Axis Gimbal 4K Camera",
    brand: "DJI",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "pocket-gimbal-cams",
    ...
    microCategory: "handheld-gimbal-cams",
    microCategoryName: "1-Inch Sensor Gimbal Cams",
    seriesId: "dji-pocket-series",
    generation: "Gen 1 (2018)",
    launchYear: 2018,
    marketStatus: "legacy-archive",
    previousModelId: null,
    nextModelId: "dji-pocket-2",
    keyUpgrade: "Original 1/2.3-inch sensor 3-axis motorized gimbal pioneer",
    rating: 4.5,
    reviewCount: 9800,
    badge: "📜 Historical Gimbal Cam Pioneer",
    priceINR: 18999,
    mrpINR: 32990,
    priceUSD: 199,
    discountPercent: 42,
    ...
    inStock: true,
    specs: { sensor: "1/2.3\" CMOS", video: "4K 60fps", stabilization: "3-Axis Mechanical", weight: "116g" },
    pros: ["Pioneered pocket motorized gimbal vlogging", "Ultra light 116g"],
    cons: ["Small non-rotating screen", "Needs lightning/type-C phone dongle"],
    prices: [{ store: "Amazon.in", priceINR: 18999, priceUSD: 199, url: "/go/amazon-in/dji-osmo-pocket-1", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The revolutionary handheld 3-axis motorized gimbal camera that started the pocket vlogging revolution."
  },
  {
    id: "dji-pocket-2",
    market: "global",
    title: "DJI Pocket 2 Creator Combo 4K 64MP Camera",
    brand: "DJI",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "pocket-gimbal-cams",
    ...
    microCategoryName: "1-Inch Sensor Gimbal Cams",
    seriesId: "dji-pocket-series",
    generation: "Gen 2 (2020)",
    launchYear: 2020,
    marketStatus: "live-discounted",
    previousModelId: "dji-osmo-pocket-1",
    nextModelId: "dji-osmo-pocket-3",
    keyUpgrade: "Upgraded 1/1.7\" 64MP sensor, wider 20mm lens & wireless transmitter handle",
    rating: 4.7,
    reviewCount: 12400,
    badge: "💡 Top Value Discounted Gimbal Cam",
    priceINR: 24999,
    mrpINR: 38990,
    priceUSD: 279,
    discountPercent: 35,
    image: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { sensor: "1/1.7\" CMOS 64MP", video: "4K 60fps / HDR", stabilization: "3-Axis Mechanical", weight: "117g" },
    pros: ["Wider 20mm equivalent focal length for selfie framing", "Includes wireless mic in Creator Combo"],
    cons: ["Fixed horizontal screen"],
    prices: [{ store: "Amazon.in", priceINR: 24999, priceUSD: 279, url: "/go/amazon-in/dji-pocket-2", inStock: true, bestDeal: true, country: "IN" }],
    summary: "Proven 64MP pocket camera with wider lens and wireless lapel microphone."
  },

  // 2. GoPro Hero Lineage
  {
    id: "gopro-hero-7-black",
    market: "global",
    title: "GoPro HERO 7 Black 4K Action Camera",
    brand: "GoPro",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "action-360-cams",
    subCategoryName: "Action & 360° Recorders",
    microCategory: "moto-vlog-action",
    microCategoryName: "Moto-Vlog & 360 Action Cams",
    seriesId: "gopro-hero-series",
    generation: "Gen 1 HyperSmooth (2018)",
    launchYear: 2018,
    marketStatus: "legacy-archive",
    previousModelId: null,
    nextModelId: "gopro-hero-8-black",
    keyUpgrade: "Pioneered HyperSmooth digital EIS stabilization & TimeWarp hyperlapse",
    rating: 4.52,
    reviewCount: 16800,
    badge: "📜 1st HyperSmooth Pioneer",
    priceINR: 14999,
    mrpINR: 37000,
    priceUSD: 149,
    discountPercent: 59,
    image: "https://images.unsplash.com/photo-1533310266094-8898a03807dd?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { video: "4K 60fps", photo: "12MP", stabilization: "HyperSmooth 1.0", waterproofing: "10m" },
    pros: ["First GoPro with buttery smooth HyperSmooth digital stabilization", "Super light weight"],
    cons: ["Monochrome front status screen only"],
    prices: [{ store: "Amazon.in", priceINR: 14999, priceUSD: 149, url: "/go/amazon-in/gopro-hero-7", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The action camera that revolutionized digital video stabilization forever."
  },
  {
    id: "gopro-hero-11-black",
    market: "global",
    title: "GoPro HERO 11 Black 5.3K Action Camera with 8:7 Full-Frame Sensor",
    brand: "GoPro",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "action-360-cams",
    ...
    microCategoryName: "Moto-Vlog & 360 Action Cams",
    seriesId: "gopro-hero-series",
    generation: "Gen 5 (2022)",
    launchYear: 2022,
    marketStatus: "live-discounted",
    previousModelId: "gopro-hero-10-black",
    nextModelId: "gopro-hero-12-black",
    keyUpgrade: "First 8:7 ratio 1/1.9\" sensor allowing 16:9 widescreen & 9:16 vertical crops from 1 file",
    rating: 4.75,
    reviewCount: 9400,
    badge: "💎 Best Value Discounted GoPro",
    priceINR: 32999,
    mrpINR: 51500,
    priceUSD: 329,
    discountPercent: 35,
    image: "https://images.unsplash.com/photo-1533310266094-8898a03807dd?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { video: "5.3K 60fps / 4K 120fps", photo: "27MP", stabilization: "HyperSmooth 5.0 + 360° Horizon Lock", waterproofing: "10m" },
    pros: ["8:7 sensor aspect ratio lets you crop for YouTube & Instagram Shorts from a single take", "10-bit color depth"],
    cons: ["Requires Media Mod for external 3.5mm mic input"],
    prices: [{ store: "Amazon.in", priceINR: 32999, priceUSD: 329, url: "/go/amazon-in/gopro-hero-11", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The ultimate 8:7 aspect ratio action camera for cross-platform YouTube and Reels creators."
  },

  // 3. DJI Mic Series Lineage
  {
    id: "dji-mic-1",
    market: "global",
    title: "DJI Mic 1 Wireless Lavalier Microphone System (2 TX + 1 RX + Charging Case)",
    brand: "DJI",
    category: "audio-microphones",
    categoryName: "Audio & Microphones",
    subCategory: "wireless-mics",
    ...
    microCategory: "pro-dual-channel",
    microCategoryName: "Dual-Channel 32-Bit Float Systems",
    seriesId: "dji-mic-series",
    generation: "Gen 1 (2021)",
    launchYear: 2021,
    marketStatus: "live-discounted",
    previousModelId: null,
    nextModelId: "dji-mic-2",
    keyUpgrade: "Pioneered touch screen receiver, magnetic clip & 8GB internal safety backup recording",
    rating: 4.81,
    reviewCount: 14200,
    badge: "💰 Pro Dual Wireless Value Pick",
    priceINR: 19990,
    mrpINR: 33990,
    priceUSD: 219,
    discountPercent: 41,
    ...
    inStock: true,
    specs: { transmitters: "2 TX + 1 RX", internalStorage: "8GB (14h 24-bit audio)", range: "250m (820 ft)", battery: "15 Hours total with case" },
    pros: ["Now under ₹20,000 for dual transmitters + charging case", "8GB standalone internal recording acts as unbreakable safety backup"],
    cons: ["Does not support 32-bit float audio (24-bit LPCM only)", "Receiver wheel dial instead of Bluetooth"],
    prices: [{ store: "Amazon.in", priceINR: 19990, priceUSD: 219, url: "/go/amazon-in/dji-mic-1", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The legendary dual-channel wireless mic that set the benchmark for YouTube audio production."
  },
  {
    id: "dji-mic-mini",
    market: "global",
    title: "DJI Mic Mini Ultra-Lightweight Wireless Transmitter & Receiver",
    brand: "DJI",
    category: "audio-microphones",
    categoryName: "Audio & Microphones",
    subCategory: "wireless-mics",
    ...
    microCategoryName: "Type-C & iPhone Collar Mics",
    seriesId: "dji-mic-series",
    generation: "Gen 3 Coin (2025)",
    launchYear: 2025,
    marketStatus: "live-current",
    previousModelId: "dji-mic-2",
    nextModelId: null,
    keyUpgrade: "10g featherweight mini transmitter with Bluetooth direct connection to smartphones",
    rating: 4.88,
    reviewCount: 890,
    badge: "🪶 10g Featherweight Mini Mic",
    priceINR: 12990,
    mrpINR: 16990,
    priceUSD: 149,
    discountPercent: 23,
    image: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { weight: "10g (Ultra Light)", battery: "48 Hours with case", latency: "Low Latency 2.4GHz", bluetooth: "Direct Phone Connect" },
    pros: ["Virtually invisible on light T-shirts and dresses", "Massive 48-hour battery case life"],
    cons: ["No internal 32-bit float onboard recording"],
    prices: [{ store: "Amazon.in", priceINR: 12990, priceUSD: 149, url: "/go/amazon-in/dji-mic-mini", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The lightest 10g wireless collar mic from DJI, designed specifically for minimalist mobile vloggers."
  },

  // 4. Sony ZV Camera Series Lineage
  {
    id: "sony-zv-1",
    market: "global",
    title: "Sony ZV-1 20.1MP 1-Inch Compact Vlogging Camera",
    brand: "Sony",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "mirrorless-vlog-cams",
    ...
    microCategory: "apsc-flip-cams",
    microCategoryName: "APS-C Flip-Screen Cameras",
    seriesId: "sony-zv-series",
    generation: "Gen 1 Compact (2020)",
    launchYear: 2020,
    marketStatus: "live-discounted",
    previousModelId: null,
    nextModelId: "sony-zv-1-ii",
    keyUpgrade: "Pioneered Product Showcase AF mode, Bokeh switch button & directional 3-capsule mic",
    rating: 4.68,
    reviewCount: 15400,
    badge: "📷 1-Inch Compact Vlogging Pioneer",
    priceINR: 49990,
    mrpINR: 69990,
    priceUSD: 499,
    discountPercent: 28,
    ...
    inStock: true,
    specs: { sensor: "1-Inch Exmor RS CMOS", lens: "24-70mm f/1.8-2.8", video: "4K 30fps HDR", screen: "Vari-Angle Flip Screen" },
    pros: ["Product Showcase AF instantly shifts focus from your face to items held in front of lens", "Fast f/1.8 optical bokeh"],
    cons: ["24mm wide end is slightly narrow for arm's length walking selfie vlogs"],
    prices: [{ store: "Amazon.in", priceINR: 49990, priceUSD: 499, url: "/go/amazon-in/sony-zv-1", inStock: true, bestDeal: true, country: "IN" }],
    summary: "The compact 1-inch sensor camera that redefined YouTube tech reviews and beauty vlogs."
  },
  {
    id: "sony-zv-e10",
    market: "global",
    title: "Sony ZV-E10 24.2MP APS-C Mirrorless Vlogging Camera (Body Only)",
    brand: "Sony",
    category: "cameras-recorders",
    categoryName: "Cameras & Recorders",
    subCategory: "mirrorless-vlog-cams",
    ...
    microCategoryName: "APS-C Flip-Screen Cameras",
    seriesId: "sony-zv-series",
    generation: "Gen 2 APS-C (2021)",
    launchYear: 2021,
    marketStatus: "live-discounted",
    previousModelId: "sony-zv-1",
    nextModelId: "sony-zv-e10-ii",
    keyUpgrade: "Brought interchangeable E-mount lenses & large APS-C sensor under ₹60,000",
    rating: 4.79,
    reviewCount: 18900,
    badge: "🔥 Best Selling Mirrorless Vlogging Cam",
    priceINR: 59990,
    mrpINR: 69990,
    priceUSD: 599,
    discountPercent: 14,
    image: "https://images.unsplash.com/photo-1502920917128-1aa500764cbd?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { sensor: "24.2MP APS-C Exmor", lens: "Sony E-Mount Interchangeable", video: "4K 30fps Over-sampled from 6K", battery: "NP-FW50" },
    pros: ["Access to over 70+ Sony E-mount lenses for cinema prime bokeh", "Dedicated tally recording lamp"],
    cons: ["8-bit 4:2:0 video limits heavy color grading compared to ZV-E10 II"],
    prices: [{ store: "Amazon.in", priceINR: 59990, priceUSD: 599, url: "/go/amazon-in/sony-zv-e10", inStock: true, bestDeal: true, country: "IN" }],
    summary: "India's #1 interchangeable-lens mirrorless camera for studio YouTubers and educators."
  },

  // 5. DJI Osmo Mobile Gimbal Lineage
  {
    id: "dji-om-5",
    market: "global",
    title: "DJI OM 5 3-Axis Smartphone Gimbal Stabilizer with Extension Rod",
    brand: "DJI",
    category: "gimbals-tripods",
    categoryName: "Gimbals & Tripods",
    subCategory: "smartphone-gimbals",
    ...
    microCategory: "ai-tracking-gimbals",
    microCategoryName: "AI Face Tracking Gimbals",
    seriesId: "dji-om-series",
    generation: "Gen 3 (2021)",
    launchYear: 2021,
    marketStatus: "live-discounted",
    previousModelId: "dji-om-4",
    nextModelId: "dji-osmo-mobile-6",
    keyUpgrade: "Built-in 215mm telescopic extension selfie rod & ultra-compact folding body",
    rating: 4.65,
    reviewCount: 8700,
    badge: "💰 Extension Rod Gimbal Deal",
    priceINR: 9999,
    mrpINR: 14990,
    priceUSD: 109,
    discountPercent: 33,
    image: "https://images.unsplash.com/photo-1606092195730-5d7b9af1eef9?auto=format&fit=crop&w=800&q=80",
    inStock: true,
    specs: { payload: "290g", extension: "215mm Telescopic Rod", stabilization: "3-Axis Motorized", tracking: "ShotGuides + ActiveTrack 4.0" },
    pros: ["Integrated 215mm extension rod provides high-angle drone-like shots", "Magnetic phone clamp"],
    cons: ["Battery life shorter than OM 4 due to smaller battery cell"],
    prices: [{ store: "Amazon.in", priceINR: 9999, priceUSD: 109, url: "/go/amazon-in/dji-om-5", inStock: true, bestDeal: true, country: "IN" }],
    summary: "Ultra-compact mobile stabilizer featuring a built-in extendable selfie rod for dynamic high/low angles."
  }
];

// Include lineage products in main catalog
VLOGGING_PRODUCTS.push(...LINEAGE_PRODUCTS);
